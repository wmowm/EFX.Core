//请求地址(列表)
var RequestListUrl = "/Classes/GetClassesList";
//请求地址(单条记录)
var RequestUrl = "/Classes/GetClasses";
//请求地址(删除记录)
var RequestDelUrl = "/Classes/DelClasses";
//请求地址(修改)
var RequestEditUrl = "Classes/EditClasses";
//请求控制器(添加)
var RequestAddUrl = "Classes/AddClasses"
//请求地址(Select下拉框)
var RequestSelUrl = "/Classes/Select_teacher"
$(function () {
    ...
    oInit.Init = function () {
        ...
        $("#btn_edit").click(function () {
            ...
            $.post(RequestUrl, { id: arrselections[0].id }, function (data) {
                $("#id").val(data.id);
                $('.selectpicker').selectpicker('val', data.manager.id);
                $("#txt_teacher").val(data.manager.id);
                $("#txt_name").val(data.name);
                $("#txt_sort_id").val(data.sort_id);
                $("#txt_start_time").val(data.start_time);
                $("#txt_end_time").val(data.end_time);
