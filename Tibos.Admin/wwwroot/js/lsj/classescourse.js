//请求地址(列表)
var RequestListUrl = "/ClassesCourse/GetClassesCourseList";
//请求地址(单条记录)
var RequestUrl = "/ClassesCourse/GetClassesCourse";
//请求地址(删除记录)
var RequestDelUrl = "/ClassesCourse/DelClassesCourse";
//请求地址(修改)
var RequestEditUrl = "ClassesCourse/EditClassesCourse";
//请求控制器(添加)
var RequestAddUrl = "ClassesCourse/AddClassesCourse"
$(function () {
...
var TableInit = function () {
    ...
    function sort_idFormatter(value, row, index)
    {
        var res;
        $.ajax({
            type: "POST",
            async: false,
            url: RequestUrl,
            data: { classes_id: $("#classes_id").val(), course_id: row.id },
    ...
    oInit.Init = function () {
        ...
        $("#btn_edit").click(function () {
            ...
            $.post(RequestUrl, { id: arrselections[0].id }, function (data) {
                ...
                $("#txt_leave").val(data.leave);

                $("#txt_leaveCourse").val(data.leaveCourse);
                $("#txt_breach").val(data.breach);
        ...
        $("#btn_delete").click(function () {
            ...
            var d = dialog({
                ...
                ok: function () {
                    ...
                    $.post(RequestDelUrl, { ids: ids, classes_id: $("#classes_id").val() }, function (data) {
                        var e = dialog({
                            padding: 30,
                            content: data.msg
                        });
