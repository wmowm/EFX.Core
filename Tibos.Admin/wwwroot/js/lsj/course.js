//请求地址(列表)
var RequestListUrl = "/Course/GetCourseList";
//请求地址(单条记录)
var RequestUrl = "/Course/GetCourse";
//请求地址(删除记录)
var RequestDelUrl = "/Course/DelCourse";
//请求地址(修改)
var RequestEditUrl = "Course/EditCourse";
//请求控制器(添加)
var RequestAddUrl = "Course/AddCourse"
//请求地址(Select下拉框)
var RequestSelUrl = "/Course/Select_teacher"
$(function () {
    ...
    oInit.Init = function () {
        ...
        $("#btn_edit").click(function () {
            ...
            $.post(RequestUrl, { id: arrselections[0].id }, function (data) {
                $("#id").val(data.id);
                $('#txt_teacher').selectpicker('val', data.manager.id);
                $("#txt_teacher").val(data.manager.id);
                $("#txt_course_type").selectpicker('val', data.course_type.id);
                $("#txt_course_type").val(data.manager.id);
                $("#txt_duration").val(data.duration);
                $("#txt_name").val(data.name);
                $("#txt_sort_id").val(data.sort_id);
                $("#txt_synopsis").val(data.synopsis);
