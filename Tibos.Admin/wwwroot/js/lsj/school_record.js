//请求地址(列表)
var RequestListUrl = "/Record/GetRecordList";
//请求地址(单条记录)
var RequestUrl = "/Record/GetRecord";
//请求地址(删除记录)
var RequestDelUrl = "/Record/DelRecord";
//请求地址(修改)
var RequestEditUrl = "Record/EditRecord";
//请求控制器(添加)
var RequestAddUrl = "Record/AddRecord"
$(function () {
        ...
        $("#btn_edit").click(function () {
            ...
            $.post(RequestUrl, { id: arrselections[0].id }, function (data) {
                ...
                if (data.manager != null) {
                    ...
                    $("#txt_salesman").val(data.manager.id);
                }
                if (data.school_info != null) {
                    $('#txt_school').selectpicker('val', data.school_info.id);
                    $("#txt_school").val(data.school_info.id);
                }
