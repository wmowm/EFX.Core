...
;$.fn.zSign = function (options) {
    ...
    var _btnPanel = $("<div class='panels'><button class='btn btn-default add ' >盖 章</button><button class='btn btn-default print'>打 印</button><button class='btn btn-default cancel'>关 闭</button></div>").appendTo(price_box);
