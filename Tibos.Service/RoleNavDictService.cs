...
{
	public class RoleNavDictService:RoleNavDictIService
	{
		private readonly IRoleNavDict dao;
        public RoleNavDictService(IRoleNavDict dao)
		{
            this.dao = dao;
        }
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public RoleNavDict Get(string id) 
        {
            return dao.Get(id);
        }
        public RequestParams GetWhere(RoleNavDictRequest request)
        {
        ...
        public IList<RoleNavDict> GetList()
        {
            return dao.LoadAll();
        }
        ...
        /// </summary>
        /// <returns></returns>
        public IList<RoleNavDict> GetList(RoleNavDictRequest request) 
        {
            RequestParams rp = GetWhere(request);
            return dao.GetList(rp);
        }

        public IList<RoleNavDict> GetList(Expression<Func<RoleNavDict, bool>> expression, List<SortOrder<RoleNavDict>> expressionOrder, Pagination pagination)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public int GetCount(RoleNavDictRequest request)
        {
            RequestParams rp = GetWhere(request);
        ...
        /// <returns></returns>
        public string Save(RoleNavDict model) 
        {
        ...
        /// <param name="m_user"></param>
        /// <returns></returns>
        public void Update(RoleNavDict model) 
        {
            dao.Update(model);
        }
