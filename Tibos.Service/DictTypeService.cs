...
{
	public class DictTypeService:DictTypeIService
	{
		private readonly IDictType dao;
        ...
        public IList<DictType> GetList(Expression<Func<DictType, bool>> expression, List<SortOrder<DictType>> expressionOrder, Pagination pagination)
        {
        ...
        /// <returns></returns>
        public string Save(DictType model) 
        {
