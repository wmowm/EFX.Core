...
{
	this.e = biFromDecimal(encryptionExponent);//biFromHex(encryptionExponent);
	this.d = biFromDecimal(decryptionExponent);//biFromHex(decryptionExponent);
	this.m = biFromDecimal(modulus);//biFromHex(modulus);
